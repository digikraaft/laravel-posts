...
//                'Test title'
//            );
//        $this->assertInstanceOf(AlternativePostModel::class, $this->testModel->latestReview());
//    }
//
//    /** @test */
...
//        $this->assertTrue($review->latestReview()->is(CustomModelKeyPostModel::first()));
//    }
//
//    /** @test */
